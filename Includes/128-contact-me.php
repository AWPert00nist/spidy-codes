...
if ($loggedIn) {
    $to = "sbajaj040@gmail.com";
    $subjectToShivam = "Feedback: " . $formType;
    $message = "Name: " . $name . "\n";
    $message .= "Category: " . $formType . "\n";
    $message .= "Email: " . $email . "\n";
    $message .= "Feedback: " . $feedback . "\n";
    $headers = "From: Shivam Bajaj <sbajaj040@gmail.com>" . "\r\n" .
            "Reply-to: sbajaj040@gmail.com" . "\r\n" .
            "X-Mailer: PHP/" . phpversion();
    if (!mail($to, $subjectToShivam, $message, $headers)) {
